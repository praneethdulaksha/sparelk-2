                ...
                <div className='flex justify-between w-full flex-col sm:flex-row'>
                    <div className='flex'>
                        <div
                            ...
                            style={{ backgroundImage: `url(http://localhost:3000/images/${item.image})` }} onClick={navigateToItemPage} ></div>

                        <div className='flex flex-col justify-between'>
                            <div className='flex items-center'>
                                <h6 className='text-gray-500 uppercase text-sm'>{item.code ? item.code : 'n/a'}</h6>
                                <h6 className='ml-5 truncate w-56 lg:w-80'>{item.name}</h6>
                            </div>
                            <div>
                                <h6 className='text-gray-500 mr-2'>{item.brand} {item.vehicleModel}</h6>
                            </div>
                            ...
                            <h6 className='text-green-600 underline text-sm'>{item.category}</h6>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col items-end justify-between gap-5'>
                        ...
                        <div className='flex gap-5'>
                            <button className='border border-red-300 text-red-400 px-3 rounded-md text-lg shadow-lg hover:scale-110 duration-75' onClick={handleDelete}>Remove</button>
                            <button className='border border-blue-300 px-3 text-blue-400 rounded-md text-lg shadow-lg hover:scale-110 duration-75' onClick={handleActive}>{item.isActive ? 'Inactive' : 'Active'}</button>
                            <button className='bg-green-300 px-3 rounded-md text-lg shadow-lg hover:bg-green-400 hover:scale-110 duration-75' onClick={() => navigate('/add-item/' + item._id)}>Update</button>
                        </div>
                    </div>
                </div>
            </div>
